...
def convert_accumulation(values, units):
    ...
    # ECMWF puede devolver "m" o "m of water equivalent" para tp/sf.
    ...
    for step in STEPS:
        ...
        if step == 0:
            ...
            try:
                ...
                manifest["steps"][skey]["precipitation_total"] = record(
                    out, units, vals, source, b,
            ...
            try:
                ...
                manifest["steps"][skey]["snowfall_water_equivalent"] = record(
                    out, units, vals, source, b,
                    "Equivalente en agua de la nevada acumulada. No se presenta como espesor de nieve en cm."
                )
                successes += 1
            except Exception as exc:
