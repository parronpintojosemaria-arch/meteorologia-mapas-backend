...
EXPECTED={'surface':1352,'lower':1020,'upper':1020}; TOTAL=sum(EXPECTED.values())
...
def main():
 ...
 if dict(dc)!={'spain':1696,'europe':1696}:raise RuntimeError(f'dominios {dict(dc)}')
