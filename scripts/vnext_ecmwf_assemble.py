...
EXPECTED={'surface':1472,'lower':1020,'upper':1020}; TOTAL=sum(EXPECTED.values())
...
def main():
 ...
 if dict(dc)!={'spain':1756,'europe':1756}:raise RuntimeError(f'dominios {dict(dc)}')
