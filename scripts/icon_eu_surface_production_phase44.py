...
PUBLIC = ROOT / "public-icon44" / "icon-eu"
STEPS = tuple(range(49, 79))
...
def main():
    ...
    data["step_rule"] = "+49..+78 h cada 1 h"
    data["production_block"] = {"start_hour": 49, "end_hour": 78, "cadence_hours": 1}
    data["summary"]["map_files"] = len(STEPS) * len(p42.PRODUCTS)

    new = PUBLIC / "manifest-icon-eu44.json"
