...
with sync_playwright() as p:
    ...
    page.goto("http://127.0.0.1:8772/index.html", wait_until="domcontentloaded", timeout=45000)
    page.wait_for_function("window.__phase66oReady === true", timeout=45000)
    assert "250 hPa" in page.locator("h1").inner_text()
    ...
    for model, (count, last_step) in EXPECTED.items():
        ...
        st = page.evaluate("window.__phase66oState()")
    ...
    page.screenshot(path=str(OUT / "screenshot-phase66o.png"), full_page=True)
    report = {
        "phase": "66O",
        "level_hpa": 250,
        "browser": "chromium",
    ...
    (OUT / "browser-smoke-phase66o.json").write_text(
...
print("66O browser smoke OK · 250 hPa · horizontes finales 3/3 · intervalos reales OK")
